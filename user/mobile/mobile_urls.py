...
urlpatterns = [
    ...
    path('profile/', mobile_views.mobile_profile, name='mobile_profile'),
    path('user/role/', mobile_views.get_user_role),
    ...
    path('profile/view/', mobile_views.mobile_profile_view, name='mobile_profile_view'),
