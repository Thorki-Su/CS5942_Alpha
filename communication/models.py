...
class ChatMessage(models.Model):
    ...
    task = models.ForeignKey('task.Task', on_delete=models.CASCADE, null=True, blank=True, related_name='chat_messages')
...
class VideoCallSession(models.Model):
    ...
    participant = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='participated_calls', null=True, blank=True)
    task = models.ForeignKey('task.Task', on_delete=models.CASCADE, null=True, blank=True, related_name='video_sessions')
