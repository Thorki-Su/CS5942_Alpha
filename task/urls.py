...
urlpatterns = [
    ...
    path('task/application/<int:application_id>/confirm/', views.task_confirm, name='task_confirm'),
    path('task/application/<int:application_id>/record/', views.task_record, name='task_record'),
]